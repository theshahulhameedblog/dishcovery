...
3. **Crop (Optional)**: Use the built-in crop tool to focus on specific menu sections
4. **View Results**: Browse translated dishes with descriptions, ingredients, and allergen info
5. **Explore Details**: Tap any dish to see full nutritional information and Google Images
...
- Keep the menu flat and in focus
- Avoid tilted or angled shots
- Make sure text is clearly visible

### Translation & Results

**Q: Why wasn't any dish detected?**
A: This can happen if:
- The image is too blurry or dark
- The menu text is too small or unclear
- The menu is handwritten (AI works best with printed text)
- There's excessive glare or shadows

**Tips for better results:**
- Take photos in good lighting
- Get closer to the menu for clearer text
- Use the crop tool to focus on specific sections
- Try multiple angles if needed

**Q: The translation seems incorrect**
A: While our AI is highly accurate, occasional errors can occur with:
...
A: We source nutritional data from:
- **Nutritionix**: Commercial food database (high accuracy)
- **USDA FoodData Central**: Government nutrition database
- **AI Estimates**: When exact matches aren't available

Estimates are based on common recipes and serving sizes. Actual values may vary by restaurant.

**Q: Why is allergen information missing for some dishes?**
A: Allergen detection is based on:
- Listed ingredients in the menu (if available)
...
- **Server issue**: Our backend may be temporarily unavailable (try again in a few minutes)
- **API limits**: You may have reached the daily scan limit (if applicable)
...
- Photos are processed in real-time and **not stored** on our servers
- Images are sent to OpenAI for AI analysis only
- No personal information is collected
- See our [Privacy Policy](./PRIVACY_POLICY.md) for full details

**Q: Do you sell my data?**
A: **Absolutely not.** We do not collect, store, or sell any personal data.
...
### Current Limitations
- Handwritten menus may not process accurately
- Very decorative or stylized fonts can reduce accuracy
- Extremely long menus may need to be scanned in sections
- Image quality affects translation accuracy

### In Progress
- Improving handwritten menu recognition
- Adding more regional cuisine support
- Expanding allergen database
...
- [App Store Listing](https://apps.apple.com/app/dishcovery/id[YOUR_APP_ID])
